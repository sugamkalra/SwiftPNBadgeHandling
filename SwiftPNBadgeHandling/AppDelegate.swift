...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool
    {
        ...
        // Added by Sugam - Initialize Notifications Method Calling When App is Launched
        self.initializeNotificationServices()
        
        // Added by Sugam - To clear Badges from App Icon
    ...
    // Added by Sugam - Method To Register For Notifications
    ...
    // Added by sugam - To handle push notifications
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.Appirio.SwiftPNBadgeHandling" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("SwiftPNBadgeHandling", withExtension: "momd")!
